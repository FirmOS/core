//
// HH: FILE IS PATCHED / PATCH SUBMITTED TO FPC TEAM / DO NOT INCLUDE IN ANY DISTRIBUTIONS !!
//
//
...
type
  ...
  TJSONInstanceType = (jitUnknown, jitNumberInteger,jitNumberInt64,jitNumberFloat,
                       jitString, jitBoolean, jitNull, jitArray, jitObject, jitNumberQWord);
  TJSONFloat = Double;
